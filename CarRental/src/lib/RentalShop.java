...
public class RentalShop {
    ...
    public void saveShopData() {
        ...
        // Handle locking differently - don't close channel while lock is in use
        ...
        try {
            ...
            if (lock != null) {
                try {
                    ...
                    System.out.println("ERROR: Could not release the file lock.");
                }
            }
            if (channel != null) {
                try {
                    ...
                    System.out.println("ERROR: Could not close the file channel.");
                }
            }
            if (raf != null) {
                try {
                    ...
                    System.out.println("ERROR: Could not close the random access file.");
                }
            }
        }
    }
...
private void loadShopData() {
    ...
    try {
        ...
        try {
            ...
            System.out.println("ERROR: Could not read from the shop file - class not found.");
            e.printStackTrace();
        } finally {
            ois.close();
        }
